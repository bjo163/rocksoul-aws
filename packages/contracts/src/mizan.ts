...
export interface MizanInput {
  semantic?: Record<string, number>; semanticVector?: Record<string, unknown>; factors?: MizanFactors; scale?: MizanScale;
  actionGateVector?: MizanVector; impactVector?: MizanVector; timeFactor?: Record<string, unknown> | MizanTemporalContext;
  causality?: Record<string, unknown>; domainVector?: MizanDomainVector; semanticObservation?: Record<string, unknown>;
  evidenceCount?: number; confidence?: number; evidenceQuality?: number;
}

export interface MizanResult {
  raw?: number; band?: number; score?: number; semantic?: Record<string, number>;
  perspectives?: Record<string, unknown>; semanticVector?: Record<string, unknown>;
  actionGateVector?: MizanVector; impactVector?: MizanVector; timeFactor?: Record<string, unknown>;
  causality?: Record<string, unknown>; domainVector?: MizanDomainVector; scale?: MizanScale;
  scaleFactor?: number; semanticScaleAffinity?: number; assessment?: Record<string, unknown>;
  xp?: Record<string, unknown>; trace?: unknown; modelOnly?: boolean; [key: string]: unknown;
}
...
export function isMizanInput(value: unknown): value is MizanInput {
  ...
  return ['evidenceCount', 'confidence', 'evidenceQuality'].every((key) => input[key] === undefined || (typeof input[key] === 'number' && Number.isFinite(input[key])));
}
