...
export default function App() {
  return <main>
    ...
    <section className="section shell" id="status">
      <div className="status-card"><div><p className="eyebrow"><span /> CURRENT BASELINE</p><h2>v4.32 integration baseline</h2><p>Semantic, Revelation, Witness, review-gate, web contract, API hermetic lanes, dan baseline PostgreSQL 18 telah memiliki bukti sertifikasi. Advanced concurrency, PITR, dan distributed deployment tetap diperlakukan sebagai pekerjaan lanjutan.</p></div><div className="status-list"><p><i className="ok" />Preflight & certification</p><p><i className="ok" />1,007 API checks</p><p><i className="ok" />500 adversarial Mīzān cases</p><p><i className="ok" />PostgreSQL 18 baseline</p></div></div>
    </section>
